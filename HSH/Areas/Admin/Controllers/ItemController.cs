...
namespace HSH.Areas.Admin.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDays,PropertyId,ItemTypeId,SectionId,PartId,IsAvailable")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDays,PropertyId,ItemTypeId,SectionId,PartId,IsAvailable")] Item item)
        {
            if (ModelState.IsValid)
            {
